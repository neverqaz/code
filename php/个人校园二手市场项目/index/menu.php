...
<div class="header_btm">
		<div class="menu_s">
			<ul>
				<li class="active"><a href="show.php<?php if(isset($_GET["xxxx"]))print "?xxxx=".$_GET["xxxx"]."&&id=".$_GET["id"]; ?>">首页</a></li>
				...
				<li><a href="../contact/contact.php?xxxx=<?php if(isset($_GET["xxxx"])){print $_GET["xxxx"];print "&&id=".
				$_GET["id"];}else {$_GET["xxxx"]=null;print $_GET["xxxx"];}?>">联系我们</a></li>
				<div class="clear"></div>
			</ul>
		</div>
	...
	<div class="header_right">
		<ul>
			<li><a href="../productmanage/checkname.php?xxxx=<?php if(isset($_GET["xxxx"])){print $_GET["xxxx"];print "&&id=".
				$_GET["id"];}else {$_GET["xxxx"]=null;print $_GET["xxxx"];}?>"></i><span class="color1">个人管理</span></a></li>
