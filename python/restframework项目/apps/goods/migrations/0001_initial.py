# Generated by Django 2.1 on 2018-08-29 14:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 29, 14, 23, 14, 780196), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '商品轮播图',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 29, 14, 23, 14, 778295), verbose_name='添加时间')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsCategory',
            fields=[
                ...
                ('code', models.CharField(default='', help_text='类别编号', max_length=30, verbose_name='类别code')),
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 29, 14, 23, 14, 776234), verbose_name='添加时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 29, 14, 23, 14, 777158), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '商品类别',
                'verbose_name_plural': '商品类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2018, 8, 29, 14, 23, 14, 779327), verbose_name='添加时间')),
